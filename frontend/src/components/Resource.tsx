  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">📘 Gonka Project Overview</h2>
      ...
      {/* Official Resources */}
      <div>
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Official Resources</h2>
      ...
      {/* Developer Resources */}
      <div>
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Developer Resources</h2>

...
export function MarketStats() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
      ...
      <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 mb-8">
        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
          {/* 左边 Price */}
          <div className="hrink-0 min-w-[220px]">
          ...
          <div className="flex-1">
            <div className="lg:col-span-2 bg-gray-100 rounded-lg p-5 border border-gray-200">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
        ...
        <div>
          <div className="text-sm text-gray-500 mb-1">Mining rewards</div>
          <div className="text-lg font-semibold text-gray-900">
        ...
        <div>
          <div className="text-sm text-gray-500 mb-1">Genesis Allocation</div>
          <div className="text-lg font-semibold text-gray-900">
        ...
        <div>
          <div className="text-sm text-gray-500 mb-1">System Tokens</div>
          <div className="text-lg font-semibold text-gray-900">
        ...
        <div>
          <div className="text-sm text-gray-500 mb-1">Community pool</div>
          <div className="text-lg font-semibold text-gray-900">
